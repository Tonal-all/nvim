...
_G.packer_plugins = {
  ...
  ["ai.vim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/ai.vim",
  ...
  ["copilot-cmp"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/root/.local/share/nvim/site/pack/packer/opt/copilot-cmp",
  ...
  ["copilot.lua"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/root/.local/share/nvim/site/pack/packer/opt/copilot.lua",
  ...
  ["mason.nvim"] = {
    after = { "clangd_extensions.nvim", "mason-lspconfig.nvim", "rust-tools.nvim" },
  ...
  neorg = {
    ...
    needs_bufread = true,
    only_cond = false,
    path = "/root/.local/share/nvim/site/pack/packer/opt/neorg",
  ...
  ["nvim-cmp"] = {
    after = { "cmp-cmdline", "cmp-buffer", "cmp-nvim-lsp-signature-help", "cmp-dap", "cmp-path" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ufo", "nvim-ts-rainbow", "nvim-treesitter-textobjects", "nvim-treesitter-refactor", "nvim-ts-autotag", "nvim-ts-context-commentstring", "neorg", "hlargs.nvim" },
  ...
  ["overseer.nvim"] = {
    ...
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/overseer.nvim",
  ...
  ["telescope.nvim"] = {
    after = { "lazygit.nvim", "nvim-neoclip.lua", "telescope-frecency.nvim" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'Comment.nvim', 'lualine.nvim', 'indent-blankline.nvim', 'leap.nvim', 'targets.vim', 'statuscol.nvim', 'nvim-treesitter', 'mason.nvim', 'gitsigns.nvim', 'bufferline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au CmdlineEnter * ++once lua require("packer.load")({'nvim-cmp'}, { event = "CmdlineEnter *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-cmp', 'copilot.lua', 'cmp-snippy'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'neoconf.nvim'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
vim.cmd [[au CursorHold * ++once lua require("packer.load")({'nvim-toggler', 'neo-tree.nvim', 'nvim-hlslens', 'vim-fugitive', 'trouble.nvim', 'symbols-outline.nvim', 'splitjoin.vim', 'telescope.nvim', 'nvim-colorizer.lua', 'sniprun'}, { event = "CursorHold *" }, _G.packer_plugins)]]
time([[Defining lazy-load event autocommands]], false)
vim.cmd("augroup END")
vim.cmd [[augroup filetypedetect]]
time([[Sourcing ftdetect script at: /root/.local/share/nvim/site/pack/packer/opt/neorg/ftdetect/norg.vim]], true)
vim.cmd [[source /root/.local/share/nvim/site/pack/packer/opt/neorg/ftdetect/norg.vim]]
time([[Sourcing ftdetect script at: /root/.local/share/nvim/site/pack/packer/opt/neorg/ftdetect/norg.vim]], false)
vim.cmd("augroup END")
